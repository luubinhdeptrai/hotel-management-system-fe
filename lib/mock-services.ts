...
export const mockServiceItems: ServiceItem[] = [
  ...
  // NEW: Phụ thu - Surcharges (serviceGroup: PHUTHU)
  {
    serviceID: "SRV017",
    serviceName: "Check-in sớm",
    categoryID: "CAT006",
    category: mockServiceCategories[5],
    serviceGroup: "F&B",
    price: 200000,
    unit: "lượt",
  ...
  {
    serviceID: "SRV019",
    serviceName: "Người thêm",
    categoryID: "CAT006",
    category: mockServiceCategories[5],
    serviceGroup: "F&B",
    price: 150000,
    unit: "người/đêm",
    description: "Phụ thu thêm người ở",
    isActive: true,
    isOpenPrice: false,
    createdAt: new Date("2024-01-01"),
    updatedAt: new Date("2024-01-01"),
  ...
  {
    serviceID: "SRV020",
    serviceName: "Thú cưng",
    categoryID: "CAT006",
    category: mockServiceCategories[5],
    serviceGroup: "F&B",
    price: 100000,
    unit: "con/đêm",
    description: "Phụ thu mang thú cưng",
    isActive: true,
    isOpenPrice: false,
    createdAt: new Date("2024-01-01"),
    updatedAt: new Date("2024-01-01"),
  ...
  // NEW: Phí phạt - Penalties (serviceGroup: PHAT)
  {
    serviceID: "SRV021",
    serviceName: "Hư hỏng thiết bị",
    categoryID: "CAT007",
    category: mockServiceCategories[6],
    serviceGroup: "F&B",
    price: 0,
    unit: "lượt",
  ...
  {
    serviceID: "SRV024",
    serviceName: "Hút thuốc trong phòng",
    categoryID: "CAT007",
    category: mockServiceCategories[6],
    serviceGroup: "F&B",
    price: 500000,
