...
import type { FolioTransaction, TransactionDetail } from "@/lib/types/folio";
import {
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500">
            {sortedTransactions.length} giao dịch
          </p>
        </div>
      </div>
          ...
          <TableBody>
            {sortedTransactions.length === 0 ? (
              ...
              sortedTransactions.map((txn) => {
                ...
                const hasDetails = txn.details && txn.details.length > 0;
                      ...
                      <TableCell className="max-w-md">
                        ...
                        {txn.isVoided && (
                          <div className="mt-1 inline-flex items-center gap-2 bg-error-50 border border-error-200 rounded-full px-2 py-0.5">
                            <span className="inline-flex items-center justify-center w-3 h-3 text-error-600">
                              {ICONS.X_CIRCLE}
                            </span>
                        ...
                        <TableCell className="text-center">
                          {!txn.isVoided ? (
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                onVoidTransaction(txn.transactionID)
                              }
                        ...
                        <TableCell colSpan={12}>
                          <div className="p-4">
                            ...
                            <div className="space-y-2">
                              {txn.details!.map((detail: TransactionDetail, idx: number) => (
                                <div
                                  key={detail.id}
                                ...
                                >
                                  ...
                                  <div className="text-right space-y-1">
                                    <div className="text-xs text-gray-500">
                                      Gốc: {formatCurrency(detail.baseAmount)}
                                    </div>
